<template>
    ...
    <v-card class="common-card" flat height="200" width="180" :style="{
      ...
      <v-card-text class="pt-0 ma-auto" >
        <p class="body-2 font-weight-medium ma-0 white--text">
          <router-link
            class="white--text text-decoration-none text-md-h4"
            :to="{
              name: 'Album',
              params: {
                id: 1,
